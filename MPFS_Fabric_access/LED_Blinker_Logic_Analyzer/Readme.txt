LED Blinker Logic Anaylzer Project Tutorial
...
This project is based on the LED_Blinker project except, it has debug
circuitry added. For Logic analyzer, used Synplify Pro to create the 
debug circuitry, and Synopsys Identify tools. These are third party tools
that are default logic analyzer tools in Libero SoC design suite.
...
Logic Analyzer:
Trigger at the posedge of when ready becomes one. Samples all handshaking
signals and output LEDs. 
