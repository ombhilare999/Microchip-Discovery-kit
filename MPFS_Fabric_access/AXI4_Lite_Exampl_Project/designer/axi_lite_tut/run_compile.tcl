...
set_partition_info -name "/axi_lite_tut" -timestamp "1721783212"
set_partition_info -name "/axi_lite_tut/axi_lite_tut" -timestamp "1721783212"
set_compile_info \
...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\User\OneDrive\Desktop\Microship_ECE552\Introduction_Tut\SmartDesignCanvas\tutorial\synthesis\axi_lite_tut.vm"}
set_compile_info \
    -category {"Options"} \
    -name {"Limit the number of high fanout nets to display to"} \
    -value {"10"}
compile \
    -desdir {C:\Users\User\OneDrive\Desktop\Microship_ECE552\Introduction_Tut\SmartDesignCanvas\tutorial\designer\axi_lite_tut} \
    -design axi_lite_tut \
    -fam PolarFireSoC \
    -die PA5SOC095T \
    -pkg fcsg325 \
