LED Switch Logic Anaylzer Project
...
Project Description:
This project essentially is a LED switch controlled by switches. 
Based on the 2 bit value from the switch, specific led will turn
on. This project also contains (1) handshaking logic
...
Logic Analyzer:
(1) Trigger at the posedge of when ready is high. Samples all handshaking
signal.

(2) Trigger when AXI data is 2'b2 indicating LED3 should be on. Samples 
the LEDs signals.
